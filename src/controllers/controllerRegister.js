const RegisterModel = require('../models/RegisterModel'); // Importa o modelo de Register, que é responsável por lidar com a lógica de registro de usuários no banco de dados
...
exports.register = async (req, res) => {
    const register = new RegisterModel(req.body);   // Cria uma nova instância do modelo de Register, passando os dados do formulário de registro (req.body) para o construtor da classe Register
